...
try:
    ingredient_name = raw_input('What is the ingredient you would like to search for? ').strip()  # Strip any whitespace
...
if ingredient_name:
    ...
    if not meals:  # Check if we received any data at all. if not, then
        ...
        download_choice = raw_input('Would you like to save the results into a txt file? y/n ')
